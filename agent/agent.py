...
root_agent = LlmAgent(
  ...
  description=(
      'A monitoring agent for live television production. Watches wireless camera telemetry across the shoot and tells the director what is about to fail, in production language rather than instrument readings.'
  ),
  sub_agents=[],
  ...
  tools=[
    ...
    McpToolset(
      connection_params=StreamableHTTPConnectionParams(
        url='https://grafana-mcp-708110251968.asia-southeast1.run.app/mcp',
      ),
    )
  ],
)
